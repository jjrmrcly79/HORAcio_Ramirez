...
def main():
    ...
    code = code.replace('<BOT_TOKEN>', s['BOT_TOKEN']).replace('<SERVICE_ROLE_KEY>', s['SERVICE_ROLE_KEY']).replace('<ADMIN_SECRET>', s.get('ADMIN_SECRET', '')).replace('<DASH_TOKEN>', s.get('DASH_TOKEN', ''))
